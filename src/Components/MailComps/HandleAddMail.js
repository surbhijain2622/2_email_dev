    ...
    <div className="inner">
      ...
      <div className="mailcred-inner">
        <p className="mail-cred-para">
          Currently we only support single gmail mail credential for a single
          user.
          <br />
        ...
        {mailCred && (
          <div>
            <p className="mail-cred-para">Name : {mailCred.name}</p>
            <p className="mail-cred-para">Email : {mailCred.email}</p>
          </div>
        )}
        <p className="mail-cred-para">
          Add a new mail cred:
